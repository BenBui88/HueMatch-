...
function LandingPage() {
  ...
  return (
    <div style={{ fontFamily: 'Outfit, sans-serif', display: 'flex', flexDirection: 'column', minHeight: '100%', padding: '1.5rem' }}>
  ...
  onFocus={e => setTimeout(() => e.target.scrollIntoView({ behavior: 'smooth', block: 'start' }), 500)}
...
function MatchScreen() {
  ...
  const [showSkinCamera, setShowSkinCamera] = useState(false)
